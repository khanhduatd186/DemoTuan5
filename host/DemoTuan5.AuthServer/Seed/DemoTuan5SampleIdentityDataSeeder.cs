 ...
 * - DemoTuan5.AuthServer
 * - DemoTuan5.Web.Unified (used as linked file)
 */
public class DemoTuan5SampleIdentityDataSeeder : ITransientDependency
{
    ...
    public DemoTuan5SampleIdentityDataSeeder(

...
namespace DemoTuan5.Data;

public class DemoTuan5TenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<DemoTuan5TenantDatabaseMigrationHandler> _logger;

    public DemoTuan5TenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<DemoTuan5TenantDatabaseMigrationHandler> logger)
    {
